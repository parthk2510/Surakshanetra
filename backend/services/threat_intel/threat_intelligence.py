...
_pkg_root = Path(__file__).resolve().parent.parent.parent.parent / "crypto_threat_intel_package"
_scrapers_path = str(_pkg_root / "scrapers")
_config_path = str(_pkg_root / "config")
if _scrapers_path not in sys.path:
    sys.path.insert(0, _scrapers_path)
